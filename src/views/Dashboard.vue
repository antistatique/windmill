	...
	<div class="dashboard" v-else>
		...
		<div class="header">
			<span class="icon-right">
				...
				<svg v-b-modal.setLocalStorage version="1.1" id="Capa_1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px" style="margin-right: 7px" class="icon icon-logout" 
